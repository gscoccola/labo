...
PARAM$finalmodel$learning_rate     <-      0.012852425412736   #0.0437907293266036
PARAM$finalmodel$num_iterations    <-    279  #164
PARAM$finalmodel$num_leaves        <-   80  #1024
PARAM$finalmodel$min_data_in_leaf  <-   375  #1239
PARAM$finalmodel$feature_fraction  <-      0.615747096335355  #0.324462828627375
...
#mean(c(25.0327, 25.1, 25.3927, 24.8091, 24.8564))
