...
#agrego 500 canaritos
for( i in 1:500 ) dataset[ , paste0("canarito", i ) :=  runif( nrow(dataset)) ]
...
#mean(c(24.64, 23.9345, 24.12, 23.4764, 23.7873)) 
#23.99164

#ganancias con lambdas
#mean(c(24.1964, 24.8455, 24.2, 23.7473, 24.1982))
#24.23748
