...
PARAM$finalmodel$learning_rate     <-      0.0289229271953041   #0.0437907293266036
PARAM$finalmodel$num_iterations    <-    235  #164
PARAM$finalmodel$num_leaves        <-   891  #1024
PARAM$finalmodel$min_data_in_leaf  <-   840  #1239
PARAM$finalmodel$feature_fraction  <-      0.707960734579829  #0.324462828627375
...
#mean(c(25.5091, 24.76, 24.9055, 24.9345, 24.7764))
